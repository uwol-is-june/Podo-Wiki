...
export default async function WikiPage({ params }: Props) {
  ...
  if (user) {
    ...
    isAdminUser = isApprovedUser && profile?.role === 'admin'
  }
    ...
    <div className="max-w-[1200px] mx-auto px-4 py-6">
      ...
      <div className="mb-0">
        ...
        <div className="flex items-center gap-0 border-b border-wiki-border">
          ...
          {document.protected && !isAdminUser ? (
            <span
              className="px-4 py-2 text-sm text-wiki-text-muted/60 flex items-center gap-1 cursor-default"
              title="관리자만 수정할 수 있는 보호 문서입니다"
            >
          ...
          {isApprovedUser && (!document.protected || isAdminUser) && (
